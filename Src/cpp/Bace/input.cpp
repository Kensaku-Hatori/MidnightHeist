...
bool CInputJoypad::GetTrigger(JOYKEY nKey)
{
	...
	{
	case JOYKEY_L2:
		return (m_JoyKeyState.Gamepad.bLeftTrigger >= XINPUT_GAMEPAD_TRIGGER_THRESHOLD && m_JoyKeyStateOld.Gamepad.bLeftTrigger < XINPUT_GAMEPAD_TRIGGER_THRESHOLD);
	case JOYKEY_R2:
		return (m_JoyKeyState.Gamepad.bRightTrigger >= XINPUT_GAMEPAD_TRIGGER_THRESHOLD && m_JoyKeyStateOld.Gamepad.bRightTrigger < XINPUT_GAMEPAD_TRIGGER_THRESHOLD);
	default:
		break;
	}
